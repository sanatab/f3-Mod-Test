...
function getCurrentImageOfTheDay(){
    ...
    // console.log(date);
    fetch(`https://api.nasa.gov/planetary/apod?api_key=idq0HLVqRJ9JaAIwCuA8H2lhmXd3iZY36YCHqetB&date=${date}`)
        .then((res) => {
            return res.json();
        })
        .then((data) => {
...
function getImageOfTheDay(){
    ...
    // alert(newDate);
    fetch(`https://api.nasa.gov/planetary/apod?api_key=idq0HLVqRJ9JaAIwCuA8H2lhmXd3iZY36YCHqetB&date=${newDate}`)
        .then((res) => {
            return res.json();
        })
        .then((data) => {
